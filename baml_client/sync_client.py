...
class BamlSyncClient:
    ...
    def Classify(self, json: str,
        ...
        result = self.__options.merge_options(baml_options).call_function_sync(function_name="Classify", args={
            "json": json,
        })
    ...
    def Form_Completetion(self, json: str,
        ...
        result = self.__options.merge_options(baml_options).call_function_sync(function_name="Form_Completetion", args={
            "json": json,
        })
...
class BamlStreamClient:
    ...
    def Classify(self, json: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.Classification, types.Classification]:
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="Classify", args={
            "json": json,
        })
        return baml_py.BamlSyncStream[stream_types.Classification, types.Classification](
          result,
    ...
    def Form_Completetion(self, json: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.Completed_Form, types.Completed_Form]:
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="Form_Completetion", args={
            "json": json,
        })
        return baml_py.BamlSyncStream[stream_types.Completed_Form, types.Completed_Form](
          result,
...
class BamlHttpRequestClient:
    ...
    def Classify(self, json: str,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="Classify", args={
            "json": json,
        }, mode="request")
        return result
    def ExtractResume(self, resume: str,
    ...
    def Form_Completetion(self, json: str,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="Form_Completetion", args={
            "json": json,
        }, mode="request")
        return result
